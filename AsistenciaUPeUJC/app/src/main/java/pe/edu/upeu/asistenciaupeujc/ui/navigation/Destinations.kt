...
sealed class Destinations(
    ...
    object Pantalla1 : Destinations( "pantalla1", "Usuarios", Icons.Filled.Home )
    ...
    object UsuarioUI: Destinations("usuarioUI","Adm. Usuarios", Icons.Filled.Person)

    object UserForm: Destinations("usuarioForm?useId={usuId}", "Form Usuarios", Icons.Filled.Add){
        fun passId(usuId:String?):String{
            return "usuarioForm?useId=$usuId"
        }
    }
}